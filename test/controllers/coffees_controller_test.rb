...
class CoffeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coffee" do
    assert_difference('Coffee.count') do
      post coffees_url, params: { coffee: { measurement_type: @coffee.measurement_type, quantity: @coffee.quantity } }
    end
  ...
  test "should update coffee" do
    patch coffee_url(@coffee), params: { coffee: { measurement_type: @coffee.measurement_type, quantity: @coffee.quantity } }
