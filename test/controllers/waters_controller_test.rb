...
class WatersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create water" do
    assert_difference('Water.count') do
      post waters_url, params: { water: { measurement_type: @water.measurement_type, quantity: @water.quantity, user_id: @water.user_id } }
    end
  ...
  test "should update water" do
    patch water_url(@water), params: { water: { measurement_type: @water.measurement_type, quantity: @water.quantity, user_id: @water.user_id } }
